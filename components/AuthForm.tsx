                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    {type === 'sign-up' && (
                        <>
                            ...
                            <div className="flex gap-4">
                                <CustomInput 
                                    control={form.control} name='province' label='Province'
                                    placeholder='E.g Gauteng'
                                />
                                <CustomInput 
                                    control={form.control} name='postalCode' label='Postal Code'
                                    placeholder='E.g 0400'
                                />
                            </div>
                            <div className="flex gap-4">
                                <CustomInput 
                                ...
                                />
                                <CustomInput 
                                    control={form.control} name='ssn' label='ID'
                                    placeholder='E.g 1234567890112'
                                />
                            </div>
                        </>
                    )}
